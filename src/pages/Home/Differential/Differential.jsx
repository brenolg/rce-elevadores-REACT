    ...
    <MainContainer id="diferenciais">
      ...
      <div className="differential-cards-container">
        <div className="differential-card">
          ...
          <p className="differential-card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium magni fuga, repudiandae ab eos dicta ad at, molestias culpa voluptatibus quo aliquid perferendis debitis recusandae optio tenetur ducimus? Beatae, laboriosam. xx</p>
        </div>
        <div className="differential-card">
